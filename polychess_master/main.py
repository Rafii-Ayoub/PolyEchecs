...
from Joueur_vs_Joueur import ModeJoueurContreJoueur
from Bot_vs_player import ModeJoueurContreOrdinateur
from Bot_vs_Bot import ModeOrdinateurContreOrdinateur
